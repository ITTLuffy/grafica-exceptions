        ...
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 8; col++) {
                ...
                if (row == 0 && col == 0 || row == 0 && col == 7) {
                    try {
                        b_rook = ImageIO.read(getClass().getResourceAsStream("/src/Chess_rdt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 0 && col == 1 || row == 0 && col == 6) {
                    try {
                        b_knight = ImageIO.read(getClass().getResourceAsStream("/src/Chess_ndt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 0 && col == 2 || row == 0 && col == 5) {
                    try {
                        b_bishop = ImageIO.read(getClass().getResourceAsStream("/src/Chess_bdt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 0 && col == 3) {
                    try {
                        b_queen = ImageIO.read(getClass().getResourceAsStream("/src/Chess_qdt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 0 && col == 4) {
                    try {
                        b_king = ImageIO.read(getClass().getResourceAsStream("/src/Chess_kdt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
...
//                }
                ...
                if (row == 7 && col == 0 || row == 7 && col == 7) {
                    try {
                        w_rook = ImageIO.read(getClass().getResourceAsStream("/src/Chess_rlt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 7 && col == 1 || row == 7 && col == 6) {
                    try {
                        w_knight = ImageIO.read(getClass().getResourceAsStream("/src/Chess_nlt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 7 && col == 2 || row == 7 && col == 5) {
                    try {
                        w_bishop = ImageIO.read(getClass().getResourceAsStream("/src/Chess_blt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 7 && col == 3) {
                    try {
                        w_queen = ImageIO.read(getClass().getResourceAsStream("/src/Chess_qlt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                if (row == 7 && col == 4) {
                    try {
                        w_king = ImageIO.read(getClass().getResourceAsStream("/src/Chess_klt45.svg.png"));
                    } catch (IOException e) {
                        System.out.println(e.getMessage());
                    }
